...
class LMAwidgetController:
    ...
    def __init__(self, panels, lma_ctrl, scatter_ctrl, charge_lasso, d): #, station_number_selection, charge_lasso_widget, draw_lasso_widget, color_field_widget, animation_time_widget, animate_button, label, LMA_Controlsa, LMA_Controlsb, tools_popup, number_of_stations):
        ...
        station_number_selection = widgets.Dropdown(description='Minimum Stations:', 
        ...
        draw_lasso_widget = widgets.Button(description='Lasso')
        ...
        lasso_widget = widgets.VBox([charge_lasso_widget, draw_lasso_widget])
        ...
        # animate_button.layout.align_content = 'flex-end'
        ...
        animation_widget = widgets.VBox([animation_time_widget, animate_button])
        ...
        LMA_Controlsa = widgets.HBox([color_field_widget, 
            widgets.VBox([station_number_selection, 
            chi2_selection])
        ])
        # LMA_Controlsa.layout.align_content = 'flex-start'
        ...
        LMA_Controlsb = widgets.HBox([animation_widget, 
            lasso_widget])
        ...
        tools_popup = widgets.VBox([label, LMA_Controlsa, LMA_Controlsb],
            description='LMA Control Panel',
            )
        tools_popup.display = 'flex'
            
        # tools_popup.align_content = 'stretch'
